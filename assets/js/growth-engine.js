// Growth engine infographic: lead "particles" along the curves, and play-once-in-view.
(function () {
  var root = document.querySelector('[data-mmg]');
  if (!root) return;
  var motion = document.documentElement.classList.contains('mm-motion');
  if (!motion) return;

  var g = root.querySelector('[data-mmg-dots]'), NS = 'http://www.w3.org/2000/svg';
